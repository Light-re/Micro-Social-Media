...
- Keep the app realistic for the M335 school project: Flutter mobile client, Spring Boot backend, Dockerized MongoDB, and simple service boundaries.
- Do not commit secrets, `.env`, Firebase files, local IDE settings, build outputs, or handoff documents.
- Keep architecture documentation in sync when mobile client, backend services, Docker services, ports, or data stores change.
